...
> **Estado: 🔲 SIN RELLENAR** — el primer chat que trabaje en este repo debe analizarlo y completar todas las secciones (ver `CLAUDE.md`).

| Campo | Valor |
|---|---|
| Última actualización | — |
| Actualizado por (sesión/rama) | — |
| Tipo de app | — (Android / web / PWA / escritorio / otro) |
| **% listo para publicar** | —  % |
| Justificación del % | — |
| Destino previsto | — (Google Play / web / otro) |
...
- [ ] — (p. ej. compilar APK e instalar en el móvil, instalar plugin X, probar permiso Y)
